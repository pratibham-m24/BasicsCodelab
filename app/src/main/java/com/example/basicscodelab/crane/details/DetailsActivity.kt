...
package com.example.basicscodelab.crane.details
...
import androidx.compose.samples.crane.details.rememberMapViewWithLifecycle
import androidx.compose.samples.crane.details.setZoom
...
fun DetailsScreen(
    ...
    // Here we are setting state based on the api result
...
// based on the state we show the ui
    when {
