...
import com.example.basicscodelab.crane.details.MaxZoom
import com.example.basicscodelab.crane.details.MinZoom
...
fun rememberMapViewWithLifecycle(): MapView {
    ...
    // we are using this to add observer and to clean up once done
