...
fun ExploreSection(
    ...
    Surface(modifier = modifier.fillMaxSize(), color = Color.White, shape = BottomSheetShape) {
        Column(modifier = Modifier.padding(start = 24.dp, top = 20.dp, end = 24.dp)) {
            ...
            // created a button on to of the list to scroll to up whenever we scroll down
...
// minimize unnecessary recompositions
                // we are getting value for this using a different state
                ...
                if (showButton) {
                    //this is required to call scrollTo item
