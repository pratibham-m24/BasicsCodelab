...
package com.example.basicscodelab.reply.ui
...
import com.example.basicscodelab.reply.ui.utils.ReplyContentType
import com.example.basicscodelab.reply.ui.utils.ReplyNavigationType
    ...
    */
    ...
    when (windowSize) {
        WindowWidthSizeClass.Compact -> {
            // for compact size, set the navigation and content type
            navigationType = ReplyNavigationType.BOTTOM_NAVIGATION
            contentType = ReplyContentType.LIST_ONLY
        }
        WindowWidthSizeClass.Medium -> {
            // for medium size, set the navigation and content type
            ...
            contentType = if (foldingDevicePosture is DevicePosture.BookPosture
                ...
                // set list only content for normal posture
                ReplyContentType.LIST_ONLY
            }
        }
        WindowWidthSizeClass.Expanded -> {
            // set navigation type based on folding posture
...
private fun ReplyNavigationWrapperUI(
    ...
    if (navigationType == ReplyNavigationType.PERMANENT_NAVIGATION_DRAWER) {
        // setting permanent drawer for large device
        ...
        // setting modal drawer for any other device
...
fun ReplyAppContent(
    ...
    Row(modifier = Modifier.fillMaxSize()) {
        // show navigation rail whenever navigation type is navigation rail
        ...
        Column(modifier = Modifier
            ...
            //show different content based on the content type
            ...
            // show bottom navigation whenever navigation type is bottom navigation
