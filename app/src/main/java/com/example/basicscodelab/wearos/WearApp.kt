 ...
 */
package com.example.basicscodelab.wearos
...
import com.example.basicscodelab.wearos.theme.WearAppTheme
...
fun WearApp() {
    WearAppTheme {
        ...
        // this is for the scalingLazyListState, similar to lazylist
        val listState = rememberScalingLazyListState()
        /* *************************** Part 4: Wear OS Scaffold *************************** */
        // TODO (Start): Create a Scaffold (Wear Version)
        // using scaffold wear version. It shows timetext, vignette, positionindicator and pageindicator
        Scaffold(
            timeText = {
                // scrollaway is used to remove this when scrolled
                TimeText(modifier = Modifier.scrollAway(listState)) },
            vignette = {
                // Only show a Vignette for scrollable screens. This code lab only has one screen,
                // which is scrollable, so we show it all the time.
                //adds blur effect at the top and bottom of the scroll view
                Vignette(vignettePosition = VignettePosition.TopAndBottom)
            },
            positionIndicator = {
                // shows the position of the scroll view. When scrolliing is stopped, it disappears
                PositionIndicator(
            ...
            // it adjusts the items around the display so that there is no cut off
            ScalingLazyColumn(
