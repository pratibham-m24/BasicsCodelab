...
import com.example.basicscodelab.ui.theme.ColorPalette
import com.example.basicscodelab.ui.theme.RallyTypography
...
fun RallyTheme(content: @Composable () -> Unit) {
    ...
    MaterialTheme(colors = ColorPalette, typography = RallyTypography, content = content)
}
